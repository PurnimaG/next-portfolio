...
const Navbar = () => {  
  ...
  return (
    <div className='w-full shadow-navBarBoxShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
        <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between'>
            ...
            <div className=' hidden mdl:inline-flex items-center gap-7'>
                <ul className='flex text-[13px] gap-7'>
                    <Link href="#home" onClick={handleScroll} className="flex text-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                        <motion.li 
                    ...
                    <Link href="#about" onClick={handleScroll} className="flex text-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                        <motion.li 
                            initial={{ y: -10, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                        ...
                        >
                            ...
                            <div className='flex gap-4'>
                                <motion.a 
                                    ...
                                    href='https://github.com/PurnimaG' target="_blank"> 
                                ...
                                <motion.a 
                                    ...
                                    animate={{ y: 0, opacity: 1 }}
                                    transition={{ delay:1, ease: "easeIn" }}
                                    href='https://www.linkedin.com/in/purnimagurjar7' target="_blank"> 
                                    <span className='w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300'>
                                        <TbBrandLinkedin />
                                    </span> 
                                </motion.a>
                            ...
                            <motion.a 
                                ...
                                href='mailto:purnima.om.gurjar@gmail.com' 
                                className='text-sm w-72 tracking-widest text-textGreen text-center'>
                                <p className='text-sm tracking-wide text-textGreen'>purnima.om.gurjar@gmail.com</p>
                            </motion.a>
                            </div>
                        </motion.div>
                    </div>
